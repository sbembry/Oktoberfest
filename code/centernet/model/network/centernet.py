...
class CenterNet(nn.Module):
    ...
    def forward(self, images, y=None):#batched_inputs):
        """
        Args:
        ...
        #images, instances = batched_inputs
        images = images.cuda()
    ...
    def make_y(self, y):
        return self.get_ground_truth(y)#batched_inputs)
    ...
    def losses(self, pred_dict, gt_dict):
        ...
        # print(loss)
        return loss['loss_cls'] + loss['loss_center_reg'] + .1 * loss['loss_box_wh']#loss
    ...
    def inference(self, images):
        ...
        """
        n, c, h, w = images.shape#tensor.shape
